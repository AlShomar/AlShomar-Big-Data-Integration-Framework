...
JOB_JAR="./big-data-integration-1.0.jar Class flc.social.process.TwitterDataRetriever Name job-processing-cleaning-data Param {}"
...
$JAVA $HEAP_OPTS $JVM_PERFORMANCE_OPTS $GC_LOG_OPTS -jar $JOB_JAR > ./logs/twitter.log 2>&1 &
#rm -f nohup.out
